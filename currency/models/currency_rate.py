...
class CurrencyRateModel(models.Model):
    base_currency = models.PositiveIntegerField(choices=CurrencyChoices.choices, verbose_name='Валюта')
    goal_currency = models.PositiveIntegerField(choices=CurrencyChoices.choices, verbose_name='Валюта')
