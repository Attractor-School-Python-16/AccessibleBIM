    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('test', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='progress', to='quiz_bim.quizbim', verbose_name='Тест')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('progress_test', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_progress', to='progress.progresstest', verbose_name='Прогресс теста')),
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_question', to='quiz_bim.questionbim', verbose_name='Вопрос')),
            ],
            options={
