    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('test_bim', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='question_bim', to='test_bim.testbim', verbose_name='Тест Bim')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question_bim', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='answer_bim', to='test_bim.questionbim', verbose_name='Вопрос')),
            ],
            options={
